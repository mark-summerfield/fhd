...
class Form(wx.Frame):
    ...
    def create_bindings(self):
        ...
        self.matchesList.Bind(wx.EVT_LISTBOX_DCLICK, self.on_listbox_dclick)
    ...
    def on_listbox_dclick(self, event):
        if wx.TheClipboard.Open():
            wx.TheClipboard.SetData(wx.TextDataObject(event.String))
